...
export const MOCK_CONTRATOS = [
  {
    ...
    dataFim: '2025-01-31',
    dataTermino: '2025-01-31', // Mantido para compatibilidade
    prazoVigencia: 12,
    status: 'vigente',
    ...
    contratado: 'Papelaria e Distribuidora Escolar Ltda',
  ...
  },
  {
    ...
    dataFim: '2024-12-31',
    dataTermino: '2024-12-31', // Mantido para compatibilidade
    prazoVigencia: 10,
    status: 'vigente',
    ...
    fiscal: 'João Santos',
    fiscalContrato: 'João Santos',
    contratado: 'Auto Mecânica Jardim Ltda',
  ...
  },
  {
    ...
    dataFim: '2025-03-31',
    dataTermino: '2025-03-31', // Mantido para compatibilidade
    prazoVigencia: 12,
    status: 'vigente',
    secretaria: 'Secretaria Municipal de Saúde',
    gestor: 'Dr. Roberto Lima',
    gestorContrato: 'Dr. Roberto Lima',
    fiscal: 'Enf. Sandra Costa',
    fiscalContrato: 'Enf. Sandra Costa',
    contratado: 'Farmacêutica Saúde Total S/A',
  ...
  },
  {
    ...
    dataFim: '2024-12-15',
    dataTermino: '2024-12-15', // Mantido para compatibilidade
    prazoVigencia: 12,
    ...
    fiscal: 'João Santos',
    fiscalContrato: 'João Santos',
    contratado: 'Limpeza Urbana Jardim Ltda',

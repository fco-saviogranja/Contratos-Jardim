...
export function SignupCard({ onSignup, onBackToLogin, isLoading, error }: SignupCardProps) {
  ...
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-[448px] max-h-[90vh] overflow-y-auto">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[24px] items-start p-px relative w-[448px]">
        ...
        <div className="h-[220.188px] relative shrink-0 w-[446px]">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[220.188px] relative w-[446px]">
            ...
            <div className="absolute h-[46.188px] left-[24px] top-[136px] w-[398px]">
              <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[46.2px] left-[199.88px] text-[#4a7c59] text-[42px] text-center text-nowrap top-[-4px] tracking-[-0.84px] translate-x-[-50%] whitespace-pre">Cadastro</p>
            </div>
            
            {/* Descrição */}
            <div className="absolute h-[24px] left-[24px] top-[196.19px] w-[398px]">
              <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[199.39px] text-[#6c757d] text-[16px] text-center text-nowrap top-[-2px] translate-x-[-50%] whitespace-pre">Crie sua conta no sistema</p>
            </div>
          </div>
        </div>

        {/* Content - Formulário */}
        <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[446px] pb-6">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[24px] items-start px-[24px] py-0 relative w-[446px]">
            ...
            <form onSubmit={handleSubmit} className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                <div className="content-stretch flex gap-[8px] h-[14px] items-center relative shrink-0 w-full">
                  <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#2d2d2d] text-[14px] text-nowrap whitespace-pre">Nome completo</p>
                </div>
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                <div className="content-stretch flex gap-[8px] h-[14px] items-center relative shrink-0 w-full">
                  <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#2d2d2d] text-[14px] text-nowrap whitespace-pre">Tipo de usuário</p>
                </div>
                <div className="bg-[#f8f9fa] h-[36px] relative rounded-[6px] shrink-0 w-full">
                  <select
                    value={role}
                    ...
                    disabled={isLoading}
                    className="w-full h-full bg-transparent px-[12px] py-[4px] font-['Arimo:Regular',sans-serif] font-normal text-[14px] text-[#2d2d2d] outline-none rounded-[6px]"
                  >
